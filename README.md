i said no more explaination only the code to include in te readme file w in proer format dont include any other i can make type your explaination i need only the formated code or doecument with full step for this # React + Vite
