...
function RegisterComp() {
	...
	const RegisterData = [
		...
		},
		{
			...
			plaHolder: "Conform Your Password",
			name: "cPass"
		},
	]
	return (
		...
		>
			<div className="">
				<img src={register} alt="login image" className='h-full rounded-2xl w-auto object-cover p-3 hidden md:block' />
			</div>
			{RegisterData.map((items, i) => (
