export const ProfileFields = [
	...
	{ name: "license", label: "Do you have a License?", type: "select", options: ["Yes", "No"], required: true },
	{ name: "vehicle", label: "Do you have a Vehicle?", type: "select", options: ["Yes", "No"], required: true },
	...
	{ name: "lookingFor", label: "Looking For", type: "select", options: ["Full Time", "Part Time"] },
